...
My current plan was downscaled significantly, as instead, I'll simply have my fork serve 2 different (simple, and much more personal - not some grandiose fork that brings Discord to Cinny, like I originally wanted) purposes:
* Boykiss Chat - an Android client of Cinny (or, of my fork of it, with all the Discordisms), intended for my closest-friends groupchat, the BoyKissers (I'll just package the PWA as APK) - tho of course usable by everyone.
